								...
								<div class="ads-tabs">
									<div class="tabs-menus">
										...
										<ul class="nav panel-tabs">
										 	<li><a href="#tab1" class ="active"  data-toggle="tab">개발</a>
											...
											<div class="col-sm-6 col-md-12">
												...
												<div class="col-md-6">
													<div class="form-group ">
														...
														<input type="text" class="form-control" placeholder="전체 기간 동안 지급하는 총 금액을 입력하세요">
													</div>	
												</div>
									...
									<div class="row">
										<div class="col-sm-6 col-md-6">
											<div class="form-group ">
												...
												<input type="text" class="form-control" placeholder="개월 수와 주 수를 입력하세요. ex) 3개월 3주 -> 3.3">
											</div>	
										</div>
										<div class="col-sm-6 col-md-6">
											<div class="form-group">
