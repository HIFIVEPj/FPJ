											...
											<table cellpadding="4">
												<tr>
													...
													<td>
														...
														<span class="float-right font-weight-bold">￦<fmt:formatNumber value="${similarMList.market_price}" pattern="#,###,###,###" /><span class="fs-16"></span>
													</td>
												</tr>																															
											</table>
										</li>
											...
											<li class="item">
												...
												-->
													...
													<div class="media-body">
														...
														<h4 class="mt-2 mb-1">경력:${similarFree.pro_exp}년</h4>
													<!-- 
