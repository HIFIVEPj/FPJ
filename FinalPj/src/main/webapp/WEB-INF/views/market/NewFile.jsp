							...
							<div class="card-body">
								<div class="item2-gl ">
									<div class="item2-gl-nav d-flex">
										<h6 class="mb-0 mt-2">Showing 1 to 5 of 'db통계수' entries</h6>
									...
									<div class="tab-content">
										...
										<c:forEach items="${market}" var="list">
													...
													<div class="card border-0 mb-0">
														<div class="card-body ">
															<div class="item-card9">
																<a href="/marketDetails">${list.freelancer.free_name}</a>
																<a href="/marketDetails" class="text-dark"><h4 class="font-weight-semibold mt-1">${list.market_sub}</h4></a>
