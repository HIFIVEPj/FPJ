...
<html lang="zxx" dir="ltr">
	...
	<body class="overflow-hidden error-img">
		...
		<div class="page">
			...
			-->
				<img src="../images/error/404error.png" alt="404error" title="404error" style="margin-left: auto; margin-right: auto; display: block;"/>
				<div class="container text-center text-dark">
					<br/>
					<p class="h3 font-weight-normal mb-7 leading-normal" style="margin-bottom: 1rem !important; color:#e8564a;"><b>요청하신 페이지는 존재하지 않습니다. 주소를 올바르게 입력하셨는지 확인 부탁드립니다. 감사합니다.</b></p>
