<<<<<<< HEAD
<<<<<<< HEAD:FinalPj/src/main/webapp/WEB-INF/views/construction.jsp
...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Countdown css-->
		<link href="../plugins/jquery-countdown/countdown.css" rel="stylesheet">
	...
	<body class="construction-image" >
					...
					<div class="row">
						<div class="col-lg-8 col-xl-7 d-block mx-auto" >
							<div class="card br-7 p-6 mb-0">
								...
								<h3 class="mb-0 text-center font-weight-bold display-5">죄송합니다. 공사중 입니다.</h3>
								<div id="launch_date"></div>
								<p class="mb-5 font-weight-normal">현재 해당 서비스를 이용하실 수 없습니다. 최대한 빨리 찾아뵙기 위해 최선을 다하겠습니다.<br/>저희 웹사이트를 방문해 주셔서 감사드립니다.</p>
								...
								<!--
								<h4 class="mb-0"><strong>메일 문의 : </strong><a href="#">baramoss420@gmail.com</a></h4>
								-->
								<div class="text-right">
									메일 문의 : baramoss420@gmail.com　　　　　　　　<a href="../" class="btn btn-primary">돌아가기</a>
								</div>
							</div>
						</div>
					</div>
		...
		<!--Counters -->
		<script src="../plugins/jquery-countdown/countdown.js"></script>
		<script src="../plugins/jquery-countdown/jquery.plugin.min.js"></script>
...
<<<<<<< HEAD
>>>>>>> 6639d0921df9b65c8efd3090a1a3933ebc32d277:FinalPj/src/main/webapp/WEB-INF/views/all/construction.jsp
=======
>>>>>>> 6639d0921df9b65c8efd3090a1a3933ebc32d277
</html>