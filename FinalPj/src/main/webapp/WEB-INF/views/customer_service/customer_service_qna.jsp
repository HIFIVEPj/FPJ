			...
			<div class="container">
				<div class="row">
					...
					<div class="col-xl-10 col-lg-9 col-md-12">
						...
						<div class="card">
									<div class="card-header">
										<h3 class="card-title">Tabs Style right side</h3>
							...
							<div class="table-responsive p-5">
								<table id="example" class="table table-bordered ico-listing text-nowrap">
									...
									<tbody>
										<tr class="border-bottom">
											...
											<td><a href="customer_service_qna_content">마켓 서비스가 마음에 들지 않아 중도 취소하려고 합니다...</a></td>
										...
										<tr class="border-bottom">
											...
											<td class="text-center">결제</td>
											<td><a href="customer_service_qna_content"><i class="fa fa-lock"></i>&nbsp;&nbsp;마켓 서비스가 마음에 들지 않아 중도 취소하려고 합니다...</a></td>
											<td class="text-center">한나영</td>
											<td class="text-center">2020.01.27</td>
											<td class="text-center">213</td>
											<td class="text-center">3</td>
										...
										<tr class="border-bottom">
											...
											<td class="text-center">결제</td>
											<td><a href="customer_service_qna_content"><i class="fa fa-expeditedssl"></i>&nbsp;&nbsp;마켓 서비스가 마음에 들지 않아 중도 취소하려고 합니다...</a></td>
											<td class="text-center">한나영</td>
											<td class="text-center">2020.01.27</td>
											<td class="text-center">213</td>
											<td class="text-center">3</td>
										...
										<tr class="border-bottom">
											...
											<td class="text-center">결제</td>
											<td><a href="customer_service_qna_content">환불 관련 문의 드립니다.</a></td>
								...
								<br/>
									<div class="text-right">
										<a href="customer_service_qna_write" class="btn btn-danger">　글쓰기　</a>
									</div>
