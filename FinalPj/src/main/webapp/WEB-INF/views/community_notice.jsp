							...
							<div class="table-responsive p-5">
								<table id="example" class="table table-bordered ico-listing text-nowrap">
									...
									<tbody>
										<tr class="border-bottom">
											...
											<td class="text-center">구인</td>
											<td><a href="community_notice_content">하이파이브와 함께 할 웹 디자이너를 모십니다.</a></td>
										...
										<tr class="border-bottom">
											...
											<td class="text-center">구인</td>
											<td><a href="community_notice_content">하이파이브와 함께 할 웹 개발자를 모십니다.</a></td>
											<td class="text-center">관리자</td>
											<td class="text-center">2020.01.27</td>
											<td class="text-center">213</td>
											<td class="text-center">3</td>
										...
										<tr class="border-bottom">
											...
											<td class="text-center">등급업</td>
											<td><a href="community_notice_content">프리랜서 등급 체계가 3월부터 변경 될 예정입니다.</a></td>
											<td class="text-center">관리자</td>
											<td class="text-center">2020.01.27</td>
											<td class="text-center">213</td>
											<td class="text-center">3</td>
										...
										<tr class="border-bottom">
											...
											<td class="text-center">소식</td>
											<td><a href="community_notice_content">사무실 이전</a></td>
											<td class="text-center">관리자</td>
											<td class="text-center">2020.01.27</td>
											<td class="text-center">213</td>
											<td class="text-center">3</td>
								...
								<br/>
									<div class="text-right">
										<a href="community_notice_write" class="btn btn-danger">　글쓰기　</a>
									</div>
