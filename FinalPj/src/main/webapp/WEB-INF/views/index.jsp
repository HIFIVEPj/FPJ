								...
								<div class="item-search-tabs">
									<div class="item-search-menu">
										<ul class="nav">
											...
											<li><a href="#tab2" data-toggle="tab">마켓 서비스</a></li>
									...
									<div class="tab-content index-search-select">
										...
										<div class="tab-pane" id="tab2">
											<div class="search-background">
												<div class="form row no-gutters">
													<div class="form-group  col-xl-6 col-lg-6 col-md-12 mb-0">
														<input type="text" class="form-control" id="certificate-text" placeholder="마켓 서비스 검색">
													</div>
													<div class="form-group col-xl-4 col-lg-4 col-md-12 mb-0">
														<select class="form-control select2-show-search border-bottom-0 w-100" data-placeholder="Select">
															<optgroup label="Categories">
					...
					<div class="row text-center">
						...
						<div class="col-lg-3 col-md-6 col-sm-6">
							<div class="counter-status mb-6 mb-lg-0">
								...
								<h5>총 프로젝트 수</h5>
								<h2 class="counter mb-0">2,569</h2>건
							</div>
						</div>
						<div class="col-lg-3 col-md-6 col-sm-6">
							<div class="counter-status mb-6 mb-lg-0">
								...
								<h5>총 프로젝트 금액</h5>
								<h2 class="counter mb-0">324,345,846</h2>원
							</div>
						</div>
						<div class="col-lg-3 col-md-6 col-sm-6">
							<div class="counter-status mb-6 mb-sm-0">
								...
								<h5>총 마켓 서비스 수</h5>
								<h2 class="counter mb-0">2,314</h2>건
							</div>
						</div>
						<div class="col-lg-3 col-md-6 col-sm-6">
							<div class="counter-status">
								...
								<h5>총 프리랜서 수</h5>
								<h2 class="counter mb-0">7,253</h2>명
							</div>
						</div>
					</div>
				</div>
				...
				<div class="business-item Marketplace ">
					...
					<div class="col-xl-6">
						<div class="card">
							...
							<!--  -->
							<div class="arrow-ribbon arrow-ribbon-top-left bg-danger">마감 임박</div>
							<!--  -->
							...
							<div class="card-body">
								<div class="item-det row">
									<div class="col-md-9">
										...
										<a href="jobs.html" class="text-dark"><h4 class="mb-2">Hard ware Engineer <span class="badge badge-danger fs-12">개발</span></h4></a>
										<div class="">
									...
									<div class="col-sm-3 col-auto">
										<div class="icons mt-3 mt-sm-0 pb-0 ">
											<a href="jobs.html" class="btn btn-primary mt-1"> 자세히 보기</a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="card overflow-hidden">
							...
							<div class="card-body">
								<div class="item-det row">
									<div class="col-md-9">
										<a href="jobs.html" class="text-dark"><h4 class="mb-2">Web Designer needed <span class="badge badge-warning fs-12">디자인</span> <span class="badge badge-success fs-12"><b>D - 5</b></span><span class="fs-10 label label-danger arrowed-in-right arrowed">마감 임박</span></h4></a>
										<div class="">
											<ul class="mb-0 d-flex">
									...
									<div class="col-sm-3 col-auto">
									 ...
									 -->
									 <!-- 
									<div class="arrow-ribbon arrow-ribbon-top-right bg-danger">마감 임박</div>
									 -->
									<!--  
						...
						<div class="card">
							<div class="card-body">
								<div class="item-det row">
									<div class="col-md-9">
										<a href="jobs.html" class="text-dark"><h4 class="mb-2">Looking For Project Leader <span class="badge badge-danger fs-12">개발</span></h4></a>
										<div class="">
											<ul class="mb-0 d-flex">
						...
						<div class="card overflow-hidden">
							...
							<div class="card-body">
								<div class="item-det row">
									<div class="col-md-9">
										<a href="jobs.html" class="text-dark"><h4 class="mb-2">Web Developer Freelancer <span class="badge badge-info fs-12">퍼블리싱</span></h4></a>
										<div class="">
											<ul class="mb-0 d-flex">
						...
						<div class="card">
							<div class="card-body">
								<div class="item-det row">
									<div class="col-md-9">
										<a href="jobs.html" class="text-dark"><h4 class="mb-2">Requirement for Web Developer <span class="badge badge-default fs-12">기타</span></h4></a>
										<div class="">
											<ul class="mb-0 d-flex">
					...
					<!--총 10개를 보여줄거면 여기까지가 5개, 그 다음부터 새로운 5개-->
						...
						<div class="card">
							<div class="card-body">
								<div class="item-det row">
									<div class="col-md-9">
										<a href="jobs.html" class="text-dark"><h4 class="mb-2">Openings For PHP Developer <span class="badge badge-primary fs-12">기획</span></h4></a>
										<div class="">
											<ul class="mb-0 d-flex">
												<li class="mr-5"><a href="#" class="icons"><i class="si si-briefcase text-muted mr-1"></i>Pinlist Solutions</a></li>
												<li class="mr-5"><a href="#" class="icons"><i class="si si-location-pin text-muted mr-1"></i> USA</a></li>
											</ul>
										</div>
									</div>
						...
						<div class="card overflow-hidden">
							...
							<div class="card-body">
								<div class="item-det row">
									<div class="col-md-9">
										<a href="jobs.html" class="text-dark"><h4 class="mb-2">Wanted Java Developer <span class="badge badge-primary fs-12">기획</span></h4></a>
										<div class="">
											<ul class="mb-0 d-flex">
												<li class="mr-5"><a href="#" class="icons"><i class="si si-briefcase text-muted mr-1"></i> IT Hardware &amp; Network Pvt ltd</a></li>
						...
						<div class="card overflow-hidden">
							...
							<div class="card-body">
								<div class="item-det row">
									<div class="col-md-9">
										<a href="jobs.html" class="text-dark"><h4 class="mb-2">Sales Executive and Marketing <span class="badge badge-danger fs-12">개발</span></h4></a>
										<div class="">
											<ul class="mb-0 d-flex">
						...
						<div class="card overflow-hidden">
							...
							<div class="card-body">
								<div class="item-det row">
									<div class="col-md-9">
										<a href="jobs.html" class="text-dark"><h4 class="mb-2">Urgently Wanted Delivery Boys <span class="badge badge-warning fs-12">디자인</span></h4></a>
										<div class="">
											<ul class="mb-0 d-flex">
						...
						<div class="card overflow-hidden">
							...
							<div class="card-body">
								<div class="item-det row">
									<div class="col-md-9">
										<a href="jobs.html" class="text-dark"><h4 class="mb-2">Openings For Hr Recruiters <span class="badge badge-danger fs-12">개발</span></h4></a>
										<div class="">
											<ul class="mb-0 d-flex">
					...
					<div class="col-xl-6">
						<div class="card overflow-hidden">
							...
							<div class="card-body">
								<div class="item-det row">
									<div class="col-md-9">
										<a href="jobs.html" class="text-dark"><h4 class="mb-2">Web Designer needed <span class="badge badge-warning fs-12">디자인</span></h4></a>
										<div class="">
											<ul class="mb-0 d-flex">
								...
								<div id="categorizes-demo" class="owl-carousel owl-carousel-icons5">
									<div class="item">
										<div class="card mb-0">
											...
											<div class="item-card-img">
												<a href="books.html"></a>
												<img src="../images/products/books/1.png" alt="img" class="cover-image">
											</div>
											...
											<div class="card-body">
												<div class="item-card2">
													<div class="item-card2-desc">
														<small class="">By: 한나영</small>
														<div class="item-card2-text mt-1">
															<a href="books.html" class="text-dark"><h4 class="font-weight-bold">반응형 홈페이지 제작</h4></a>
														</div>
														<p class="">[SEO최적화] 거품없는 가격으로 반응형 홈페이지 제작, 홈페이지 제작 해드립니다.</p>
														<h2>300,000 <span class="fs-16">원</span> <!-- <span class="fs-16"><del>$25</del></span> --></h2>
														<div class="item-card2-rating mb-0">
															<div class="rating-stars d-inline-flex">
																<input type="number" readonly="readonly" class="rating-value star" name="rating-stars-value"  value="4.5">
																...
																</div>&nbsp;4.7 (88<span class="fs-13">개의 평가</span>)
															</div>
														</div>
									...
									<div class="item">
										<div class="card mb-0">
											...
											<div class="item-card-img">
												<a href="books.html"></a>
												<img src="../images/products/books/2.png" alt="img" class="cover-image">
											</div>
											...
											<div class="card-body">
												<div class="item-card2">
													<div class="item-card2-desc">
														<small class="">By: 김소담</small>
														<div class="item-card2-text mt-1">
															<a href="books.html" class="text-dark"><h4 class="font-weight-bold">반응형 홈페이지 제작</h4></a>
														</div>
														<p class="">고퀄리티 반응형 홈페이지 제작해드립니다.</p>
														<h2>600,000 <span class="fs-16">원</span> <!-- <span class="fs-16"><del>$25</del></span> --></h2>
														<a href="#" class="icons">
															<i class="fa fa-star text-warning"></i>
															<i class="fa fa-star text-warning"></i>
															<i class="fa fa-star text-warning"></i>
															<i class="fa fa-star text-warning"></i>
															<i class="fa fa-star-half-o text-warning mr-1"></i>&nbsp;4.7 (7<span class="fs-13">개의 평가</span>)</a>
														<!-- 
														<a href="books.html" class="btn btn-primary text-white mt-3">자세히 보기</a>
														-->
													</div>
									...
									<div class="item">
										<div class="power-ribbon power-ribbon-top-left text-warning"><span class="bg-warning"><i class="fa fa-bolt"></i></span></div>
										<div class="owl-product text-center border">
											<div class="owl-productimg">
												<img src="../images/products/5.png" alt="" class="">
											</div>
											<div class="owl-productinfo">
												<a href="ecommerce.html"><h5 class="text-center text-dark mt-3 mb-1 font-weight-bold">Glod Watch</h5></a>
												<p class="text-dark text-center mb-2">soluta nobis est eligendi cumque</p>
												<h3 class="mb-3"> $63</h3>
									...
									<div class="item">
										...
										<div class="owl-product  text-center border">
											<div class="owl-productimg">
												<img src="../images/products/6.png" alt="" class="">
											</div>
											<div class="owl-productinfo">
												<a href="ecommerce.html"><h5 class="text-center text-dark mt-3 mb-1 font-weight-bold">Sport Shoe</h5></a>
												<p class="text-dark text-center mb-2">soluta nobis est eligendi cumque</p>
												<h3 class="mb-3"> $75</h3>
												<a href="#" class="btn btn-primary btn-sm">Add To cart</a>
											</div>
									...
									<div class="item">
										...
										<div class="owl-product  text-center border">
											<div class="owl-productimg">
												<img src="../images/products/8.png" alt="" class="">
											</div>
											<div class="owl-productinfo">
												<a href="ecommerce.html"><h5 class="text-center text-dark mt-3 mb-1 font-weight-bold">Watern Shoe</h5></a>
												<p class="text-dark text-center mb-2">soluta nobis est eligendi cumque</p>
												<h3 class="mb-3"> $65</h3>
												<a href="#" class="btn btn-primary btn-sm">Add To cart</a>
											</div>
									...
									<div class="item">
										<div class="owl-product text-center border">
											<div class="owl-productimg">
												<img src="../images/products/2.png" alt="" class="">
											</div>
											<div class="owl-productinfo">
												<a href="ecommerce.html"><h5 class="text-center text-dark mt-3 mb-1 font-weight-bold">Matel Watch</h5></a>
												<p class="text-dark text-center mb-2">soluta nobis est eligendi cumque</p>
												<h3 class="mb-3"> $78</h3>
												<a href="#" class="btn btn-primary btn-sm">Add To cart</a>
											</div>
									...
									<div class="item">
										...
										<div class="owl-product text-center border">
											<div class="owl-productimg">
												<img src="../images/products/4.png" alt="" class="">
											</div>
											<div class="owl-productinfo">
												<a href="ecommerce.html"><h5 class="text-center text-dark mt-3 mb-1 font-weight-bold">Digital Watch</h5></a>
												<p class="text-dark text-center mb-2">soluta nobis est eligendi cumque</p>
												<h3 class="mb-3"> $68</h3>
												<a href="#" class="btn btn-primary btn-sm">Add To cart</a>
											</div>
				...
				<div id="myCarousel1" class="owl-carousel owl-carousel-icons2">
					<div class="item">
						<div class="card mb-0">
							...
							<div class="card-body">
								<img src="../images/faces/female/test2.png" alt="img" class=" avatar avatar-xxl brround mx-auto">
								<div class="item-card2">
					...
					<div class="item">
						<div class="card mb-0">
							...
							<div class="card-body">
								<img src="../images/faces/female/test1.png" alt="img" class=" avatar avatar-xxl brround mx-auto">
								<div class="item-card2">
									<div class="item-card2-desc text-center">
										<div class="item-card2-text mt-3">
											<a href="employer-list.html" class="text-dark"><h4 class="font-weight-bold">한나영</h4></a>
					...
					<div class="item">
						<div class="card mb-0">
							...
							<div class="card-body">
								<img src="../images/faces/female/test3.png" alt="img" class=" avatar avatar-xxl brround mx-auto">
								<div class="item-card2">
									<div class="item-card2-desc text-center">
										<div class="item-card2-text mt-3">
											<a href="employer-list.html" class="text-dark"><h4 class="font-weight-bold">한나영</h4></a>
					...
					<div class="item">
						<div class="card mb-0">
							<div class="card-body">
								<img src="../images/faces/male/21.jpg" alt="img" class=" avatar avatar-xxl brround mx-auto">
								<div class="item-card2">
									<div class="item-card2-desc text-center">
										<div class="item-card2-text mt-3">
					...
					<div class="item">
						<div class="card mb-0">
							<div class="card-body">
								<img src="../images/faces/female/11.jpg" alt="img" class=" avatar avatar-xxl brround mx-auto">
								<div class="item-card2">
									<div class="item-card2-desc text-center">
										<div class="item-card2-text mt-3">
					...
					<div class="item">
						<div class="card mb-0">
							<div class="card-body">
								<img src="../images/faces/male/12.jpg" alt="img" class=" avatar avatar-xxl brround mx-auto">
								<div class="item-card2">
									<div class="item-card2-desc text-center">
										<div class="item-card2-text mt-3">
					...
					<div class="item">
						<div class="card mb-0">
							<div class="card-body">
								<img src="../images/faces/female/15.jpg" alt="img" class=" avatar avatar-xxl brround mx-auto">
								<div class="item-card2">
									<div class="item-card2-desc text-center">
										<div class="item-card2-text mt-3">
					...
					<div class="item">
						<div class="card mb-0">
							<div class="card-body">
								<img src="../images/faces/female/17.jpg" alt="img" class=" avatar avatar-xxl brround mx-auto">
								<div class="item-card2">
									<div class="item-card2-desc text-center">
										<div class="item-card2-text mt-3">
