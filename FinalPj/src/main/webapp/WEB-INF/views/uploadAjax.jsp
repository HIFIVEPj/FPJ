...
<script>
	...
	*/
	...
	$(document).ready(function(){
		...
		//var cloneObj = $(".uploadDiv").clone(); // 파일을 업로드 하면 초기화 되어 계속 파일을 올릴 수 있게 하는 것. dropify 쓸거면 필요없음
			...
			$.ajax({
			 ...
			 data: formData,
				 ...
				 success: function(result){
				 	...
				 	//$(".uploadDiv").html(cloneObj.html()); // 파일을 업로드 하면 초기화 되어 계속 파일을 올릴 수 있게 하는 것. dropify 쓸거면 필요없음
				 }
			 }); //$.ajax
		});
