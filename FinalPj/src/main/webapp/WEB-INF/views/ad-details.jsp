<<<<<<< HEAD:FinalPj/src/main/webapp/WEB-INF/views/ad-details.jsp
						...
						-->	
								...
								<div class="card-footer">
									<div style="text-align: right; vertical-align:center;">
										<span style="font-size:30px">결제금액</span>
...
<!--footer-->
<%@ include file="/WEB-INF/views/include/footer.jsp"%>
>>>>>>> 6639d0921df9b65c8efd3090a1a3933ebc32d277:FinalPj/src/main/webapp/WEB-INF/views/market/ad-details.jsp
<!--/footer-->